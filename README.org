...
* Usage
To use this library, please add dependence in your [[./demo/project.clj]]:
#+BEGIN_SRC clojure
...
#+END_SRC
Now you can use [[./demo/src/demo/demo.org][demo.org]] to write your documentation and source codes together,
and any codes in [[./demo/src/demo/demo.org][demo.org]] will be loaded automatically.
